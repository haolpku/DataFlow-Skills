...
Core text processing operators for DataFlow.

中文: [README_CN.md](./README_CN.md)

## What is this

Text processing operators for generation, filtering, refinement, and evaluation. All operators follow DataFlow standards
